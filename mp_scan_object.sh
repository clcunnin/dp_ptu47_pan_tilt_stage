# Topics to record
TOPICS="/mp_stereo/left/image_raw /mp_stereo/right/image_raw /mp_stereo/left/camera_info /mp_stereo/right/camera_info /dp_ptu47/pan_tilt_status /dp_ptu47/pan_tilt_status_stamped /tf"
